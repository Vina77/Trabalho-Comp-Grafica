...
def palavra_chav(texto,numeros,imagem,bouding_boxes,nums):
    ...
    if quantidade>0:                                             #caso deseja digitar as palavras chaves                       
        ...
        for palavrachave in range(0,len(linha)):
            for palavra in texto:
                for x in range(0,len(palavra)):                #procura a palavra digitada e retorna a posição dela
                    if linha[palavrachave]==palavra[x]:
                        posicao_palavra_texto.append(x)
                        
        
        for compara in texto:
            for x in range(0,len(compara)):
                for y in numeros:
        ...
        numero_table=[]
        for numero in texto:
            for nums in range(0,len(numero)):
        ...
        for y in range(0,len(numero_table)):
            cont=0
                ...
                if troca[z]=="," or troca[z]==".":                  #verifica se tem . ou ,
                    ...
                    for num in tipos_numero:                #caso float
                        if troca[tam]==num:
                            ...
                            nums_converte.append(novo_numero)
        ...
        for x in range(0,len(linha)):
            for y in range(0,len(nums_converte)):         
                novo_numero=int(nums_converte[y])
                tabela.iloc[y,1]=nums_converte[y]
        ...
        for y in range(0,len(numeros)):
            ...
            tam=tam-1
            tam2=len(numeros[y])
            for z in range(0,len(troca)):                         #verifica se tem . ou ,
                if troca[z]=="," or troca[z]==".":
                    ...
                    for num in tipos_numero:        #caso int
                        if num==troca[z]:
                            cont+=1
                            if cont==tam2:
                                novo_numero=troca
